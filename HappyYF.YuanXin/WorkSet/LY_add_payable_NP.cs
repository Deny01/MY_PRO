...
{
    public partial class LY_add_payable_NP : Form
    {
        public string nowsuppilercode;
        public LY_add_payable_NP()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(dateTimePicker1.Text))
            {
                ...
                string sql = @"insert into ly_payable_NP (supplier_code,pay_date,prepaymoney,pay_people ,remark)
